...
import time
import requests
from config import amap_key, redis_info, message_tokens, RedisUtil
...
if __name__ == "__main__":
    ...
    while 1:
        ...
        item = {
            ...
            "userid": str(userId),
            "reserve_rule": 0,
            "item_codes": ["10941", "10942", "10056","2478"],
        }
        items.append(item)
